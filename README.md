...
A hybrid AI-powered virtual assistant built using Python, FastAPI, LangChain, FAISS, and Neo4j. The system combines semantic vector search with graph-based knowledge retrieval to handle complex multi-hop queries efficiently.

# Features
Hybrid Retrieval Pipeline
Integrated FAISS for semantic vector search.
Used Neo4j graph database for relationship-aware query execution.
Combined structured and unstructured data retrieval for better response accuracy.
